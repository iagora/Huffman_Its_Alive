...
Metodo que realiza a compactação
  ...
  -Apos a codificação do arquivo criar uma tipo de array como se fosse um pacote com cabeçalho para
  dar informações ao decodificador de como decodificar o arquivo 
  -Criar uma forma de enviar a tabela de codificação para o receptor decodificar arquivo
